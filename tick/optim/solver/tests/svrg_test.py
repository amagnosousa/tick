...
class Test(TestSolver):
    ...
    def test_variance_reduction_setting(self):
        ...
        with self.assertRaisesRegex(ValueError, msg):
            svrg = SVRG(variance_reduction='truc')
        with self.assertRaisesRegex(ValueError, msg):
            svrg.variance_reduction = 'truc'
    ...
    def test_delayed_updates(self):
        ...
        msg = '^delayed_updates should be one of "exact, proba", got "truc"$'
        with self.assertRaisesRegex(ValueError, msg):
            svrg = SVRG(delayed_updates='truc')
        with self.assertRaisesRegex(ValueError, msg):
            svrg.delayed_updates = 'truc'
